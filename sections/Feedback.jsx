  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <p className="mt-[24px] font-normal sm:text-[24px] text-[12px] sm:leading-[45px] 
          leading-[16px] text-white">
          "With the development of today's
           technology, metaverse is very useful for
           today's work, or can be called web 3.0. by
           using metaverse you can use it sa anything"
        </p>
      </motion.div>

      <motion.div
        variants={fadeIn('left', 'tween', 0.2, 1)}
        className="relative flex-1 flex justify-center place-items-center"
      >
        <img
          src="/planet-09.png"
          alt="planet-09"
